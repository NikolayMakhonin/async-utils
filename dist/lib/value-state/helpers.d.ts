...
import { AsyncOrValue, IValueState, OfValueStateOrValues } from './contracts';
...
export declare function asyncToValueState<TValue>(valueAsync: AsyncOrValue<TValue>, state?: ValueState<TValue>): Promise<ValueState<TValue>>;
